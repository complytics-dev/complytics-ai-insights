            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight">
                  Eliminate Comp Plan Confusion—{" "}
                  <span className="text-gradient bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">AI-Powered Automation for SaaS</span>
                </h1>
